...
if("TRUE" STREQUAL "TRUE")
  set(basics_SOURCE_PREFIX /home/ss/catkin_ws/src/ROS-pup-sub)
  set(basics_DEVEL_PREFIX /home/ss/catkin_ws/devel)
  set(basics_INSTALL_PREFIX "")
  set(basics_PREFIX ${basics_DEVEL_PREFIX})
else()
  set(basics_SOURCE_PREFIX "")
  set(basics_DEVEL_PREFIX "")
  set(basics_INSTALL_PREFIX /home/ss/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'muhammad-97 <muhammad-97@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ss/catkin_ws/src/ROS-pup-sub/${idir}'.  Ask the maintainer 'muhammad-97 <muhammad-97@todo.todo>' to fix it.")
    endif()
